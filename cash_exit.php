...
if (is_post() && post('action') === 'create_exit') {
  if (!$cashbox) {
  ...
  if ($error !== '') {
    ...
    $st = db()->prepare("INSERT INTO cash_movements (cashbox_id, type, detail, amount, user_id) VALUES (?, 'exit', ?, ?, ?)");
...
<main class="page">
  <div class="container">
    <div class="page-header">
      <h2 class="page-title">Salida de caja</h2>
