...
$form = [
  ...
  'import_discount_default' => '0',
  'import_dedupe_mode' => 'LAST',
  'import_default_cost_type' => 'UNIDAD',
  'import_default_units_per_pack' => '',
];

if (is_post() && post('action') === 'create_supplier') {
  ...
  if ($error === '') {
    try {
      ...
      if ($st->fetch()) {
        ...
        redirect('suppliers.php?created=1');
      }
    } catch (Throwable $t) {
...
<main class="page">
  <div class="container">
    <div class="page-header">
      <div><h2 class="page-title">Nuevo proveedor</h2></div>
